      ...
      <div className="container mx-auto flex justify-start items-center min-h-[400px] lg:h-[805px]">
        <div className="lg:max-w-[650px] text-center mx-auto lg:text-left lg:mx-0">
          <div className="hidden xl:flex mb-6 ml-5">
            <Image src={pretitleImg} width={'100%'} height={'auto'} alt='hero' />
          </div>
          <h1 className="text-5xl lg:text-7xl uppercase font-bold -tracking-[0.05em] mb-10">Una primera <br /> <span className="text-orange font-normal">aproximación al </span> <br/> bienestar de las mascotas</h1>
          <button className="btn btn-orange mx-auto lg:mx-0">Aprender más</button>
        </div>
      </div>
    </section>
  )
